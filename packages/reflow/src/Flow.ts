...
export class FlowProxy<ViewsMap extends ViewsMapInterface, Input extends any = void, Output extends any = void, State extends object = {}, Notifications extends FlowEventsDescriptor = {}, Events extends FlowEventsDescriptor = {}, ExternalEvents extends FlowEventsDescriptor = {}> extends Promise<Output> {
	...
	public state: State;
	public input: Input;
	constructor(executor: (resolve: (value: Output | PromiseLike<Output>) => void, reject: () => void) => FlowProxy<ViewsMap, Input, Output, State, Notifications, Events, ExternalEvents> | null, flowProc: Flow<ViewsMap, Input, Output, State>, toolkit: FlowToolkit<ViewsMap>, input?: Input, state?: State, options?: FlowOptions) {
